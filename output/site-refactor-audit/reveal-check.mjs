...
for(const width of [1440,768,390]){
 ...
 await p.screenshot({path:`output/site-refactor-audit/404-menu-${width}.png`,fullPage:true});
 await context.close();
}
await b.close();await writeFile('output/site-refactor-audit/revealed-links.json',JSON.stringify({results,footer},null,2));console.log(JSON.stringify({results,footer}));
