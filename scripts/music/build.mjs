...
await build({
  absWorkingDir: root,
  entryPoints: { site: "site.js", "music/music": "music/music.js", "music/album": "music/album.js" },
...
await copyFile(join(root, "music/player-config.json"), join(output, "music/player-config.json"));
