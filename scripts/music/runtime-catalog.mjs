...
const audioTracks = allowlist.tracks.filter(track => track.playback.kind === "file");
...
if (Object.keys(index.tracks).length !== audioTracks.length) throw new Error(`Generate runtime catalog from ${mediaIndex}: media index must contain exactly the published audio tracks.`);
